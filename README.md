...
This project is a simple machine learning notebook that predicts house prices using different regression models.

## What this project does

- Loads a house price dataset.
- Checks the data for missing values.
- Splits the data into training and testing sets.
- Scales the features.
- Trains and compares multiple regression models.
- Finds the best model based on R2 score.

## Dataset

The dataset contains 3,800 rows and 12 columns.
...
The target column is `housepriceinr`.

## Models used

These models were tested in the notebook:
...
Among all the models, **Random Forest Regression** gave the best performance with an R2 score of about `0.9265` [page:1].
...
4. Check data shape and info.
5. Confirm there are no missing values.
...
This notebook is made for learning and practice. It shows how different regression models perform on the same house price dataset [page:1].
