...
### 📊 Comparing Regression Models for Accurate House Price Estimation
...
Data Analysis • Feature Scaling • Cross Validation • Model Evaluation
...
🔹 Implemented **Leave-One-Out Cross Validation (LOOCV)**
...
The goal of this project is to predict house prices using machine learning regression algorithms and compare their performance using different evaluation metrics.
